...
Delay     - Delay in seconds between each authentication attempt. Helps avoid rate limiting and Smart Lockout. Default is 0.
VerboseErrors - Displays full error details for unknown errors to help with troubleshooting.
```
